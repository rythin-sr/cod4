...
split {
        ...
        if (settings[vars.CurrentCheckpoint.Trim()]) {
		// First ability
        if ((vars.missionList.Contains(vars.CurrentCheckpoint)) && (vars.CurrentCheckpoint == "6") && (vars.CurrentScene == "1") ||
		// Lion King
		((vars.missionList.Contains(vars.CurrentCheckpoint)) && (vars.CurrentCheckpoint == "2") && (vars.CurrentScene == "1")) || 
		// Boss fight
		((vars.missionList.Contains(vars.CurrentCheckpoint)) && (vars.CurrentCheckpoint == "7") && (vars.CurrentScene == "1")) || 
		//Return sheep
		((vars.missionList.Contains(vars.CurrentCheckpoint)) && (vars.CurrentCheckpoint == "15") && (vars.CurrentScene == "1")) || 
		// Scene 2 
		((vars.missionList.Contains(vars.CurrentCheckpoint)) && (current.checkpointloading !=0) &&  (vars.CurrentCheckpoint == "11") && (vars.CurrentScene == "1")) ||
		// Mushroom House
		((vars.missionList.Contains(vars.CurrentCheckpoint)) && (vars.CurrentCheckpoint == "7") && (vars.CurrentScene == "2")) || 
		// Indian Jones Refrence
		((vars.missionList.Contains(vars.CurrentCheckpoint)) && (vars.CurrentCheckpoint == "4") && (vars.CurrentScene == "2")) ||
		// Scene 3 Entrance 
		((vars.missionList.Contains(vars.CurrentCheckpoint)) && (vars.CurrentCheckpoint == "1") && (vars.CurrentScene == "3")) ||
		// Stream Lava
		((vars.missionList.Contains(vars.CurrentCheckpoint)) && (vars.CurrentCheckpoint == "3") && (vars.CurrentScene == "3")) ||
		// Lava Staircase
		((vars.missionList.Contains(vars.CurrentCheckpoint)) && (vars.CurrentCheckpoint == "6") && (vars.CurrentScene == "3"))) {  
